...
def get_captain_quote(category: str) -> str:
    quotes = {
        "salary": [
            ...
            "新たな資金源の確保、ご苦労！これでまた一歩前進だな！",
            "よろしい！隊の財政が潤ったな。次の任務に備えよ！",
            "うむ、見事な稼ぎだ！隊の活動は盤石だな！",
        ],
        "spend": [
            ...
            "戦略的投資、承認する！未来への布石となるだろう！",
            "必要な物資の確保は重要だ。抜かりないな、隊員！",
            "出費は最小限に、効果は最大限に。基本を忘れるな！",
        ],
        "balance": [
            "現在の財産だな。常に状況を把握しておくことは隊長の務めだ！",
            "これが我々の現在の戦力だ！無駄遣いは許さん！",
            "よし、財産の確認だな。次の探検計画を練るぞ！",
            "財政状況の報告、感謝する。常に数字は正確にな！",
            "よし、現状を把握した。これをもとに次なる一手を打つ！",
            "ふむ、これが我々の現在地か。心してかかれ！",
        ],
        "report": [
            "今週の活動報告だな。よくやった！",
            "月間報告ご苦労！隊の活動は順調そのものだ！",
            "報告感謝する。次の冒険への良い指針となるだろう！",
            "活動報告、拝見した。隊員たちの働き、見事の一言だ！",
            "素晴らしい報告だ！この調子で任務を遂行せよ！",
            "ご苦労だったな。このデータが我々の道を照らすだろう！",
        ]
    }
